...
$tabs_nav = '';
$tabs_nav .= '<ul class="wpb_tabs_nav ui-tabs-nav vc_clearfix '.$full.'">';
foreach ( $tab_titles as $tab ) {
	...
	if(isset($tab_matches[1][0])) {
		...
		if (isset($tab_matches[5][0])) {	
		$tabs_nav .= '<i class=" tabicon '.$tab_matches[5][0].'"></i>';
		}
...
if ( 'vc_tour' == $this->shortcode) {
    $output .= "\n\t\t\t" . '<div class="wpb_tour_next_prev_nav vc_clearfix"> <span class="wpb_prev_slide"><a href="#prev" title="'.__('Previous slide', 'dp-theme').'">'.__('Previous slide', 'dp-theme').'</a></span> <span class="wpb_next_slide"><a href="#next" title="'.__('Next slide', 'dp-theme').'">'.__('Next slide', 'dp-theme').'</a></span></div>';
}
