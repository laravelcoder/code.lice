...
class DP_Comments_Widget extends WP_Widget {
	...
	function DP_Comments_Widget() {
		parent::__construct(
			'widget_dp_comments', 
			__( 'DP Comments', 'dp-theme' ), 
			array( 
				'classname' => 'widget_dp_comments', 
				'description' => __( 'Use this widget to show recent comments with avatars', 'dp-theme') 
			)
		);
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? _e( 'Latest Comments', 'dp-theme' ) : $instance['title'], $instance, $this->id_base);
	...
	?>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'avatar_size' ) ); ?>"><?php _e( 'Avatar size:', 'dp-theme' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'word_count' ) ); ?>"><?php _e( 'Word count:', 'dp-theme' ); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php _e( 'Number of comments:', 'dp-theme' ); ?></label>
