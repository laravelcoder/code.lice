					...
					"fields": [
						{
							...
							"type": "Select",
							"label": "'.__('Enable', 'dp-theme').' '.($menu->name).'",
							"tooltip": "'.__('You can enable or disable showing the menu in the template.', 'dp-theme').'",
							"default": "Y",
							"other": {
								"options": {
									"Y": "'.__('Enabled', 'dp-theme').'",
									"N": "'.__('Disabled', 'dp-theme').'",
									"rule": "'.__('Conditional rule', 'dp-theme').'"
								}
							}
						},
						{
							...
							"type": "Text",
							"label": "'.__('Conditional rule', 'dp-theme').'",
							"tooltip": "'.__('You can enable showing the menu in the specific pages.', 'dp-theme').'",
							"default": "",
							"class": "",
						...
						},
						{
							...
							"type": "Select",
							"label": "'.__('Depth of ', 'dp-theme').' '.($menu->name).'",
							"tooltip": "'.__('You can specify the menu depth.', 'dp-theme').'",
							"default": "0",
							"other": {
								"options": {
									"0": "'.__('All levels', 'dp-theme').'",
									"1": "1",
									"2": "2",
									"3": "3",
									"4": "4",
