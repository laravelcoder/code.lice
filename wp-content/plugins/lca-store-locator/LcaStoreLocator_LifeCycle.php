...
include_once('LcaStoreLocator_InstallIndicator.php');

class LcaStoreLocator_LifeCycle extends LcaStoreLocator_InstallIndicator {
    ...
    protected function addSettingsSubMenuPageToSettingsMenu() {
        $this->requireExtraPluginFiles();
        $displayName = $this->getPluginDisplayName();
        add_options_page($displayName, $displayName, 'manage_options',
                         $this->getSettingsSlug(),
                         array(&$this, 'settingsPage'));
    }
    ...
    public function lcaStoreLocatorOptionsPage()
    {
        $displayName = $this->getPluginDisplayName();
        add_menu_page(
            $displayName,
