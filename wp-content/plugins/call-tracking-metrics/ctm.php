...
class CallTrackingMetrics {
  ...
  public function __construct() {
    ...
    if ( get_option('ctm_api_cf7_enabled', true) ) {
      add_filter('wpcf7_contact_form_properties', array(&$this, 'cf7_confirmation'), 10, 1);
    }
  }
  ...
  function form_init() {
    if ( ($this->cf7_enabled()) && ($this->cf7_active()) ) {
      add_action('wpcf7_before_send_mail', array(&$this, 'submit_cf7'), 1, 1);
    }
  ...
  function admin_dashboard_plugin() {
    ...
    $ctm_stats_cache_timeout = 1 * HOUR_IN_SECONDS;
